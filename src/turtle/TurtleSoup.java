...
public class TurtleSoup   {
    ...
    public static int calculatePolygonSidesFromAngle(double angle) {
        ...
        //le nombre de coté d'un polygone regulier sachant la valeur de l'angle interieur
    ...
    public static double calculateHeadingToPoint(double currentHeading, int currentX, int currentY,
        ...
        //Declaration de variable radian (valeur de l'nagle en radian) et degre (valeur de l'angle en degre)
        
        double radian;
        double degre;
        
        // calcul de la  valeur de l'angle en radian à partir des coordonnées du point actuel et suivant avec Math.atan2
    ...
    public static List<Double> calculateHeadings(List<Integer> xCoords, List<Integer> yCoords) {
        ...
        //verification de la taille des listes recu en parametre et calcul des valeurs de retour
        if (xCoords.size() == yCoords.size() && size >= 2) {
            for(int i = 0; i < size-1; i++) {
                if (i == 0) {
                   
                    
                   degreList.add(calculateHeadingToPoint(0, xCoords.get(i), yCoords.get(i), xCoords.get(i+1), yCoords.get(i+1)));
                   
                } else {
                    degreList.add(calculateHeadingToPoint(degreList.get(i-1), xCoords.get(i), yCoords.get(i), xCoords.get(i+1), yCoords.get(i+1)));
